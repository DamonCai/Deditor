...
- 2026-09-12 图表外观再调整：模式按钮加宽至最少72px、左右留白18px；三种模式统一工具栏占位，首次切换记录内容区高度，后续切换不改变外框或下方正文位置，长内容内部滚动。亮色Mermaid六次切换、长内容及撤销、暗色720px PlantUML五次切换的实际尺寸一致；12图表专项、145通用与固定副本构建通过。见[图表最新外观记录](docs/markdown-diagram-modes-2026-09-12.md)。未新增原生包、未提交推送。
