...
- 第二十轮解锁后：Review23 标题/标签/左右深层鱼骨均已原生保存重开，鱼骨撤销恢复精确字节；标题及整段联系已完成原版重读。深层鱼骨原版载入成功但全图操作受阻，标签原版、候选、打开面板与 Windows 仍待验。并行 Markdown 也在做原生测试，避免争用其 Finder 对话框。测试应用均退出，详见第二十轮记录末尾。
