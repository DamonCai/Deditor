...
- 最新性能审计：本机自建 1,001 节点/8MiB 随机附件案例，提交修改的 Base64 转换中位数约 145ms；5,001 节点整图布局约 61ms。仍可优化编辑序列化、布局失效范围、草稿/拖动渲染与历史结构共享，均尚未实施。见 [性能审计](docs/xmind-performance-audit-2026-09-12.md)；Node 计算结果不能代替浏览器/原生交互耗时。
