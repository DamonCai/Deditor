...
useEditorStore.setState({tabs:params.has("cold")?[{id:"starter",filePath:"/generated/already-open.md",content:"# 已打开的文档\n\n当前段落。\n",savedContent:"# 已打开的文档\n\n当前段落。\n"}]:[{id:"search-review",filePath:path,content:original,savedContent:original}],activeId:params.has("cold")?"starter":"search-review",workspaces:["/generated"],language:en?"en":"zh",theme:dark?"dark":"light",markdownMode:params.has("source")?"source":"visual",autoSave:"off"});
