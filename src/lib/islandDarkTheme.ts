...
const PALETTE = {
  ...
  border: "#393b40",
  selection: "#214283",      // JetBrains New UI Dark selection
  selectionMatch: "#2e436e", // brighter for "all matches"
  caret: "#cfd1d4",
  text: "#dfe1e5",           // JetBrains New UI Dark foreground
  textDim: "#868a91",
  // Syntax
